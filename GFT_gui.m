...
set(handles.figure1,'WindowButtonMotionFcn',{@mainMouseMotion,hObject});
...
function mainMouseMotion(hObject, eventdata, handles)
handles=guidata(hObject);
...
% If inside the axes 1 - Graph Signal
if mousepos(1,2) < handles.axes1.YLim(2) && mousepos(1,2) > handles.axes1.YLim(1) && mousepos(1,1) < handles.axes1.XLim(2) && mousepos(1,1) > handles.axes1.XLim(1)
    set(handles.figure1,'WindowButtonMotionFcn',{@figure1_WindowButtonMotionFcn,hObject});
end

% If inside the axes 3 - Graph Fourier Transform
if mousepos3(1,2) < handles.axes3.YLim(2) && mousepos3(1,2) > handles.axes3.YLim(1) && mousepos3(1,1) < handles.axes3.XLim(2) && mousepos3(1,1) > handles.axes3.XLim(1)
    set(handles.figure1,'WindowButtonMotionFcn',{@figure3_WindowButtonMotionFcn,hObject});
end
guidata(hObject, handles);
...
% If outside
if mousepos(1,2) > handles.axes3.YLim(2) || mousepos(1,2) < handles.axes3.YLim(1) || mousepos(1,1) > handles.axes3.XLim(2) || mousepos(1,1) < handles.axes3.XLim(1)
    set(handles.figure1,'WindowButtonMotionFcn',{@mainMouseMotion,hObject});
    set(handles.figure1,'WindowButtonDownFcn','');
    set(handles.figure1,'WindowButtonUpFcn','');
    handles.eventoSetado3 = 0;
...
if (round(mousepos(1,1)) == handles.x3) || (round(mousepos(1,1)) < 1) %|| (round(mousepos(1,1)) > length(handles.gft)) 
    return
end
if (handles.flag3 == 1)
    delete(handles.redline3);
end
if handles.eventoSetado3 == 0
